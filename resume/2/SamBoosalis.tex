%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% @brief    LaTeX2e Resume for Sam Boosalis
\documentclass[margin,line]{resume}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\name{\Large Sam Boosalis}
\begin{resume}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Contact Information

    \hfill Phone \tel{1}{617}{9220791}         \vspace{0mm}\\\vspace{0mm}%
    \hfill Email \mailto{samboosalis@gmail.com}     \vspace{0mm}\\\vspace{-4.5mm}%
    \hfill Homepage \https{sboosali.github.io}     \vspace{0mm}\\\vspace{-4.5mm}%
