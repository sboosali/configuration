...
, executable-path, file-embed, filepath, Glob, haddock-library, hslua
...
, scientific, SHA, skylighting, split, stdenv, syb, tagsoup, tasty
...
mkDerivation {
  ...
  configureFlags = [
    "-f+embed_data_files" "-f+static" "-fhttps" "-f-trypandoc"
  ];
  isLibrary = true;
  isExecutable = true;
